...
| Long-running execution process | `../../long-running-tasks/SKILL.md` | Always-on execution guidance for demo work; use the full workflow for multi-milestone or interruption-prone tasks | Authoritative |
...
- orchestration across scope, UX contract, implementation notes, and testing expectations
