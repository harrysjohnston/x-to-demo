...
_PHASE_RULES: dict[str, tuple[str, ...]] = {
    ...
    "demo_spec": (
        ...
        "DemoSpec must include runtime_input_and_guardrails with supported modalities, input capture summary, type/relevance/safety pipeline summary, reject outcomes, and explicit cancel-flow behavior.",
    ...
    "code_spec": (
        ...
        "CodeSpec must include agent_skills_to_apply, including runtime-input-guardrails-server-side, synthetic-input-presets, canonical-spec-format-parity, and generated-output-badge.",
...
_PHASE_PRIORITY_CHECKLIST: dict[str, tuple[str, ...]] = {
    ...
    "demo_spec": (
        ...
        "Include runtime_input_and_guardrails with server-side type/relevance/safety stages, reject outcomes, and cancel-flow behavior.",
    ...
    "code_spec": (
        ...
        "Include agent_skills_to_apply with runtime-input-guardrails-server-side, synthetic-input-presets, canonical-spec-format-parity, and generated-output-badge.",
