...
_PHASE_RULES: dict[str, tuple[str, ...]] = {
    ...
    "code_spec": (
        ...
        "CodeSpec must include agent_skills_to_apply, including demo-e2e, canonical-spec-format-parity, and openai-live-integration-tests; when voice/audio or image input is used, include multimodal-inputs.",
...
_PHASE_PRIORITY_CHECKLIST: dict[str, tuple[str, ...]] = {
    ...
    "code_spec": (
        ...
        "Include agent_skills_to_apply with demo-e2e, canonical-spec-format-parity, and openai-live-integration-tests; when voice/audio or image input is used, include multimodal-inputs.",
